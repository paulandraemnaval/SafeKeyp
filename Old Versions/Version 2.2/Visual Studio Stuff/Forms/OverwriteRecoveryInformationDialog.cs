...
{
    public partial class OverwriteRecoveryInformationDialog : Form
    {
        public OverwriteRecoveryInformationDialog()
        {
            InitializeComponent();
        }
        public bool result;
        ...
        public OverwriteRecoveryInformationDialog(Point safeKeypMainpageLocation, int safeKeypMainpageWidth, int safeKeypMainpageHeight)
        {
            InitializeComponent();
